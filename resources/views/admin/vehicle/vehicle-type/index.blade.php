@extends('layouts.main', ['title' => ('Vehicle Type Manage'), 'modal' => 'xl',])
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Create Or Manage Vehicle Type's</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div id="accordion">
                ...
                <div class="card card-info">
                    ...
                    <div id="create" class="panel-collapse collapse in">
                        <div class="card-body">
                            <form action="{{ route('admin.vehicle-type.store') }}" method="post" id="content_form">
                                @csrf
                                <div class="row">
                                    {{--  Vehicle Type --}}
                                    <div class="col-md-6 form-group">
                                     ...
                                     {{-- Status --}}
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select data-parsley-errors-container="#Vehicle_status_save_error" required name="status" id="status" class="form-control select" data-placeholder="Select Vehicle Type Status">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered content_managment_table"
                                    data-url="{{ route('admin.vehicle-type.datatable') }}">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Name</th>
...
<script src="{{ asset('js/pages/vehicle/vehicle-type.js') }}"></script>
@endpush
