            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.customer.index') }}">Customer</a>
                        </li>
                        <li class="breadcrumb-item active">{{ $model->custpmer_name }}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Customer Full View Information :: {{ $model->custpmer_name }}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="row">
                            ...
                            <div class="bg-success p-2 rounded-top">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-right">
                                        <h5 class="description-header">{{ $model->transaction()->where('transaction_type','Sale')->count() }}</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="bg-light p-1 py-2">
                                        ...
                                        <h6 class="text-center">Mobile : {{ $model->customer_mobile }} </h6>
                        ...
                        <div class="info-box p-0">
                                ...
                                <div class="row text-center">
                                    <div class="col-md-3">
                                        <div class="card bg-success py-3">
                                            <strong>@lang('Total Sale')</strong>
                                            <p class="text-light mb-0">
                            <span class="display_currency" data-currency_symbol="true">
                            {{ $model->total_sale }} {{ get_option('currency_symbol') }}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card bg-info py-3">
                                            <strong>@lang('Total Sale Paid')</strong>
                                            <p class="text-light mb-0">
                            <span class="display_currency" data-currency_symbol="true">
                            {{ $model->sale_paid }} {{ get_option('currency_symbol') }}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card bg-primary py-3">
                                            <strong>@lang('Sale Due')</strong>
                                            <p class="text-light mb-0">
                            <span class="display_currency" data-currency_symbol="true">
                            {{ $model->total_sale -$model->sale_paid }} {{ get_option('currency_symbol') }}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card bg-warning py-3">
                                            ...
                                            <p class="text-light mb-0">
                            <span class="display_currency" data-currency_symbol="true">
                            {{ $model->sale_return }} {{ get_option('currency_symbol') }}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            {{ $model->return_paid }} {{ get_option('currency_symbol') }}</span>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card bg-secondary py-3">
                                            ...
                                            <p class="text-light mb-0">
                            <span class="display_currency" data-currency_symbol="true">
                            {{ $model->sale_return -$model->return_paid }} {{ get_option('currency_symbol') }}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            {{ $model->opening_balance - $model->opening_balance_paid }} {{ get_option('currency_symbol') }}</span>
                                            ...
                                            @php
                                                ...
                                                $sale =$model->total_sale -$model->sale_paid;
                                                $return =$model->sale_return -$model->return_paid;
...
@push('admin.scripts')
    ...
    <script>
        ...
        sale_table = $('#sale_table').DataTable({
            ...
            ajax: '/admin/sale-voucher/sale?customer_id={{ $model->id }}',
            columnDefs: [{
                "targets": 7,
                "orderable": false,
                "searchable": false
        ...
        ob_payment_table = $('#ob_payment_table').DataTable({
            ...
            ajax: '/admin/customer/payment-list/{{ $model->id }}',
            columns: [
