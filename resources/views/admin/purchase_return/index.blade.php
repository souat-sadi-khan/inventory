@extends('layouts.main', ['title' => ('Purchase Return List'), 'modal' => 'xl',])
@push('admin.css')
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered content_managment_table" data-url="{{ route('admin.pur_voucher.return.index') }}">
                                <thead>
                                    <tr>
                                        <th>@lang('Date')</th>
