@extends('layouts.invoice',['title' => ('Print Invoice'), 'url' => route('admin.pur_voucher.purchase.create'),])
		...
		<div class="col-md-12 text-center mt-3">
			<div class="bg-primary py-2">
			 ...
			 <div class="col-md-12 text-center">
                    <span class="h3 border-one py-1 px-2">@lang('Purchase Voucher') </span>
              </div>
		</div>
	</div>
				...
				<tbody>
					 @foreach ($model->purchase as $product)
                        <tr>
                            ...
                            <td>{{ $product->qty }}</td>
                            <td>{{ $product->price }} {{ get_option('currency_symbol') }}</td>
                            <td>{{ $product->line_total }} {{ get_option('currency_symbol') }}</td>
                        </tr>
                        @endforeach
				</tbody>
				<tfoot>
