...
@section('header')
  <div class="btn-group btn-group-justified ml-3">
    ...
    <a href="{{ route('admin.products.products.index') }}" class="btn btn-light border-right ml-2 py-0"><i class="fa fa-plus"></i>@lang('New Product')</a>
  </div>
@endsection
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Update Or Manage Product</h3>
            <h3 class="card-title float-right">
                <a href="{{ route('admin.products.products.index') }}" class="btn btn-sm btn-info"><i class="fa fa-plus"></i>Create New Product</a>
            </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                @can('brand.create')
                    <div class="card card-info">
                        <a class="bg-info" data-toggle="collapse" data-parent="#accordion" href="#create">
                            <div class="card-header">
                                <h4 class="card-title">
                                    Update {{ $model->product_name }}  Product
                                </h4>
                            </div>
                        </a>
                        <div id="create" class="panel-collapse collapse in show">
                            <div class="card-body" id="data_form">
                                <form action="{{ route('admin.products.products.update',$model->id) }}" method="post" id="content_form">
                                    @method('PUT')
                                    @csrf
                                    <div class="row">
                                        {{-- Product Image --}}
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="file" name="product_image" id="product_image" class="form-control dropify" value="{{asset('storage/images/product/product/'.$model->product_image)}}"> <span class="text-danger">Product Image must be under 2000 KB and width & hieght can not be greater then 1900 pixel </span>
                                        </div>

                                        {{-- Product Name --}}
                                        <div class="col-md-6 form-group">
                                            <label for="product_name">Product Name <span class="text-danger">*</span></label>
                                            <input type="text" name="product_name" id="product_name" class="form-control" required placeholder="Enter Product Name" value="{{ $model->product_name }}">
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="input-group"  data-target-input="nearest">
                                                <input data-parsley-errors-container="#product_code_error" type="text" name="product_code" id="product_code" class="form-control" required placeholder="Enter Product Code" value="{{ $model->product_code }}">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="product_cost" id="product_cost" class="form-control input_number" required placeholder="Enter Product Cost" value="{{ $model->product_cost }}">
                                        </div>

                                        {{-- Product Price --}}
                                        <div class="col-md-6 form-group">
                                            <label for="product_price">Product Price <span class="text-danger">*</span></label>
                                            <input type="text" name="product_price" id="product_price" class="form-control input_number" required placeholder="Enter Product Price" value="{{ $model->product_price }}">
                                        </div>
                                            ...
                                            <div class="input-group"  data-target-input="nearest">
                                                <select name="product_category_id" data-placeholder="Select Category" id="product_category_id" class="form-control" >
                                                    ...
                                                    @foreach ($category_query as $item)
                                                        <option {{ $model->product_category_id==$item->id?'selected':'' }} value="{{ $item->id }}">{{ $item->category_name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="number" name="opening" id="opening" class="form-control" required placeholder="Enter Product Stock Alert" value="{{ $model->opening }}">
                                        </div>

                                        <div class="col-md-12 form-group">
                                            <label for="product_details">Product Description</label>
                                            <textarea name="product_details" id="product_details" class="form-control summernote" cols="30" rows="2"> {{ $model->product_details }}</textarea>
                                        </div>
                                    </div>
