...
<form action="{{ route('admin.vaucher.withdraw_store') }}" method="post" id="modal_form">
    @csrf
    <div class="row">
        ...
        <div class="col-md-6 form-group mx-auto" >
            <label for="amount">Withdraw Amount <span
                    class="text-danger">*</span></label>
            <input autocomplete="off" type="text" name="amount" required id="amount" class="form-control input_number" placeholder="Enter Withdraw Amount">
        </div>
