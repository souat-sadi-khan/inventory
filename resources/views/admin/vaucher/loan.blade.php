...
<form action="{{ route('admin.vaucher.loan_store') }}" method="post" id="modal_form">
    @csrf
    <div class="row">
        {{-- Receipt By A/c(Credit) --}}
        <div class="col-md-4 form-group">
            <label for="loan">Loan Account A/c <span
                    class="text-danger">*</span></label>
            <select name="loan" id="loan" data-url="{{ route('admin.vaucher.balance_check') }}" required class="form-control select" data-placeholder="Select Account">
        ...
        <div class="col-md-2 form-group">
            ...
            <input type="text" name="loan_amount" value="00.00" readonly  id="loan_amount" class="form-control" placeholder="Enter Payment Amount">
        </div>
        ...
        <div class="col-md-6 form-group mx-auto" >
            <label for="amount">Receipt Amount <span
                    class="text-danger">*</span></label>
