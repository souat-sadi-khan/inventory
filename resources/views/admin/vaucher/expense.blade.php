...
<form action="{{ route('admin.vaucher.expense_store') }}" method="post" id="modal_form">
    @csrf
    <div class="row">
        ...
        <div class="col-md-4 form-group">
            <label for="expense">Expense Account A/c <span
                    class="text-danger">*</span></label>
            <select name="expense" id="expense" data-url="{{ route('admin.vaucher.balance_check') }}" required class="form-control select" data-placeholder="Select Account">
                <option value="">Select Account</option>
        ...
        <div class="col-md-2 form-group">
            ...
            <input type="text" name="expense_amount" value="00.00" readonly  id="expense_amount" class="form-control" placeholder="Enter Payment Amount">
        </div>
