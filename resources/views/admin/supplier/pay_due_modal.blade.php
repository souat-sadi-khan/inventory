<div class="card">
	<div class="card-body">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="card-body">
					<strong>@lang('Supplier'): </strong>{{ $contact_details->sup_name }}
				</div>
			</div>
			<div class="col-md-6">
				<div class="card-body">
					<strong>@lang('Total Purchase'): </strong><span class="display_currency" data-currency_symbol="true">{{ $contact_details->total_purchase }}</span><br>
					<strong>@lang('Total Paid'): </strong><span class="display_currency" data-currency_symbol="true">{{ $contact_details->total_paid }}</span><br>
					<strong>@lang('Total Purchase Due'): </strong><span class="display_currency" data-currency_symbol="true">{{ $contact_details->total_purchase - $contact_details->total_paid }}</span><br>
			...
			<div class="col-md-6">
				<div class="card-body">
					<strong>@lang('Total Purchase Return'): </strong><span class="display_currency" data-currency_symbol="true">{{ $contact_details->total_purchase_return }}</span><br>
					<strong>@lang('Purchase Return Paid'): </strong><span class="display_currency" data-currency_symbol="true">{{ $contact_details->total_return_paid }}</span><br>
					<strong>@lang('Purchase Return Due'): </strong><span class="display_currency" data-currency_symbol="true">{{ $contact_details->total_purchase_return - $contact_details->total_return_paid }}</span>
				</div>
			</div>
   @endif
		</div>
		<form action="{{ route('admin.postPaySupplierDue') }}" method="post" enctype="multipart/form-data" id="modal_form">
			<input type="hidden" name="supplier_id" value="{{ $contact_details->supplier_id }}">
