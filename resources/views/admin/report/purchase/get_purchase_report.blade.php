<div id="print_table" class="card-body">
    ...
    <div class="text-center col-md-12">
        <h4 style="margin:0px ; margin-top: 7px; border:solid 1px #000; border-radius:50px; display:inline-block; padding:10px;"
            ...
            <b>@lang('Purchase Register Report')</b></h4>
    </div>
    <br>
        ...
        <table class="table table-hover table-bordered content_managment_table table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a data-url ="{{ route('admin.pur_voucher.purchase.show',$element->id) }}" id="btn_modal" style="cursor: pointer;">{{ $element->reference_no }}</a></td>
                     <td>{{ $element->date }}</td>
                        ...
                        <td>{{ number_format($element->shipping_charges, 2) }} {{ get_option('currency_symbol') }}</td>
            ...
            <tr>
                 <th class="text-right" colspan="3">Total</th>
                    ...
                    <th>{{ get_option('currency_symbol') }} {{ $models->sum('shipping_charges') }}</th>
