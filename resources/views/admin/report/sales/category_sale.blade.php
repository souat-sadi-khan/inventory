@extends('layouts.main', ['title' => ('Category Sales Report'), 'modal' => 'xl',])
@push('admin.css')
@endpush
@section('header')
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h4>Sale Category Wise Report</h4>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <div class="card-body text-center">
                    <div class="row">
                        <div class="col-sm-10 mx-auto">
                            <label for="date">@lang('Category')</label>
...
$(document).on('click', '#check_it', function() {
    var category_id = $('#category_id').val();
      ...
      $('#checking').show();
     $.ajax({
            url: '/admin/get_category_sale_report',
            data: {
