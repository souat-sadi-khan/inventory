	<div  id="print_table" class="card-body">
        ...
        <div class="text-center col-md-12">
            <h4 style="margin:0px ; margin-top: 7px; border:solid 1px #000; border-radius:50px; display:inline-block; padding:10px;"
                ...
                <b>@lang('Profit Loss') Report</b></h4>
        </div>
        <br>
		...
		<div class="table-responsive">
			<table class="table table-bordered table-sm">
				<tr>
					<td class="text-center">@lang('Total Sale')</td>
					<td class="text-center">
						{{ get_option('currency_symbol') }}
						{{ number_format($total_selling_price, 2) }}
					</td>
				</tr>
				<tr>
					<td class="text-center">@lang('Total Purchase')</td>
					<td class="text-center">
						{{ get_option('currency_symbol') }}
						{{ number_format($total_purchase_price, 2) }}
					</td>
				</tr>
				<tr>
					<td class="text-center">@lang('Gross Profit')</td>
					<td class="text-center">
						{{ get_option('currency_symbol') }}
