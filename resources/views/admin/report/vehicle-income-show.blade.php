	<div id="print_table" class="card-body">
	    ...
	    <div class="card-body">
			@if ($vehicle_name)
			<h2 class="text-center border-bottom"> {{$vehicle_name->name . "(" . $vehicle_name->type->name . ")"}}</h2>
			<h5 class="text-center py-2 border-bottom"> Total Investment = {{number_format($vehicle_name->investment, 2)}}</h5>
			@endif
	        <div class="row">
	            <div class="col-md-6">
                    <h5 class="text-center py-2 border-bottom">Income Report</h5>
	                <div class="table-responsive">
	                    <table class="table table-hover table-bordered table-sm">
	                        ...
	                        <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td class="text-right">{{ get_option('currency_symbol') }}
	                        ...
	                        <tfoot>
	                            <tr>
	                                ...
	                                <th class="text-right"> {{ get_option('currency_symbol') }}
	            ...
	            <div class="col-md-6">
                    <h5 class="text-center py-2 border-bottom">Expence Report</h5>
	                <div class="table-responsive">
	                    <table class="table table-hover table-bordered table-sm">
	                        <thead>
	                            <tr>
	...
	<div class="text-center mb-3">
	    ...
	    <a class="text-light btn-primary btn" onclick="printContent('{{ $print_table }}')" name="print" id="print_receipt">
