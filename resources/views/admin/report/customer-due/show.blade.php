    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover table-bordered content_managment_table table-sm">
            ...
            <tbody>
                ...
                @endphp
                <tr>
                    <td class="text-center"><a target="_blank" href="{{ route('admin.report.customer-due.unique-customer', $item['ID'])}} ">{{ $item['Name'] ?$item['Name']:'' }}</a></td>
                    ...
                    <td class="text-right">{{ get_option('currency_symbol') }}{{ number_format($balance, 2) }}</td>
                </tr>
                @endforeach
            </tbody>
            <tfoot>
