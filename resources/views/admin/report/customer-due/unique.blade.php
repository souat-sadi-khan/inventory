@extends('layouts.main', ['title' => ('Unique Customer Report'), 'modal' => 'xl',])
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Unique Customer Report</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('/home') }}"><i class="fa fa-home"
                                aria-hidden="true"></i></a></li>
                    <li class="breadcrumb-item active">Unique Customer Report</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div id="print_table" class="card-body">
            ...
            <div class="text-center col-md-12">
                <h4 style="margin:0px ; margin-top: 7px; border:solid 1px #000; border-radius:50px; display:inline-block; padding:10px;"
                    ...
                    <b> {{$customer->customer_name}}  Report</b></h4>
            </div>
            <br>
