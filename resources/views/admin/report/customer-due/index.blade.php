@extends('layouts.main', ['title' => ('Customer Report'), 'modal' => 'xl',])
@push('admin.css')
@endpush
@section('header')
                ...
                <div class="card-body text-center">
                     <div class="row">
                        ...
                        <div class="col-md-6 form-group mx-auto">
                            ...
                            <select data-url="{{ route('admin.report.show-customer-due-report') }}" name="customer_id" id="customer_id" class="form-control select" data-placeholder="Select Customer">
