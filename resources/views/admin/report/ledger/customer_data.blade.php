...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Ledger Report Customer Wise</h3>
        </div>
        <!-- /.card-header -->
            ...
            <div class="table-responsive">
                ...
                <div class="text-center col-md-12">
                    <h4 style="margin:0px ; margin-top: 7px; border:solid 1px #000; border-radius:50px; display:inline-block; padding:10px;"
                        ...
                        <b>{{ $customer->customer_name }}  Ledger Book</b></h4>
                </div>
                <br>
                <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered content_managment_table table-sm">
                    <thead class="table-info">
                        <tr>
                            <th width="5%">ID</th>
                            <th width="25%" class="text-center">Operation Date</th>
                    ...
                    <tbody>
                        ...
                        @endphp
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
                                <td class="text-center">{{ formatDate($key) }} </td>
                                <td class="text-right">{{ get_option('currency_symbol') }}{{ number_format($debit) }}</td>
                                <td class="text-right">{{ get_option('currency_symbol') }}{{ number_format($credit) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
