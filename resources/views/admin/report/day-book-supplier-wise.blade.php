            ...
            <div class="table-responsive">
                ...
                <div class="text-center col-md-12">
                    <h4 style="margin:0px ; margin-top: 7px; border:solid 1px #000; border-radius:50px; display:inline-block; padding:10px;"
                        ...
                        <b>Supplier Ledger Book Report</b></h4>
                </div>
                <br>
                <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered content_managment_table table-sm">
                    ...
                    <tbody>
                        ...
                        @if (count($data))
                            ...
                            @php
                                $supplier = App\Models\Supplier::findOrFail($key);
                                $debit = $ac['Debit'];
                                $credit = $ac['Credit'];
                                $t_debit += $debit;
                                $t_credit += $credit ;
                            @endphp
                                <tr>
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td class="text-center"><a href="{{ route('admin.report.supplier', $key . '?start_date='.$start_date.'&end_date='.$end_date)}}">{{ $supplier->sup_name }}</a></td>
                        ...
                        @else
                            <tr>
                                <td class="text-center" colspan="4">No Information Found !</td>
                            </tr>
                        @endif
                    </tbody>
                    <tfoot>
