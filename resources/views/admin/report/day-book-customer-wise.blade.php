        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Ledger Book Report</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div  class="table-responsive">
                ...
                <table class="table table-hover table-bordered content_managment_table table-sm">
                    ...
                    <tbody>
                        ...
                        @php
                            $customer = App\Models\Customer::findOrFail($key);
                            $debit = $ac['Debit'];
                            $credit = $ac['Credit'];
                            $t_debit += $debit;
                            $t_credit += $credit ;
                        @endphp
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
                                <td class="text-center"><a href="{{ route('admin.report.customer', $key . '?start_date='.$start_date.'&end_date='.$end_date)}}">{{ $customer->customer_name }}</a></td>
