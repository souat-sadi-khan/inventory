@extends('layouts.main', ['title' => ('Direct Expense Report'), 'modal' => 'xl',])
@push('admin.css')
@endpush
@section('header')
                ...
                <div class="card-body text-center">
                    <div class="row">
                        ...
                        <div class="col-md-6 mx-auto mt-2 text-center">
                            <button data-url="{{ route('admin.report.direct-expense-show') }}" type="button" id="check_it" class="btn btn-primary btn-sm w-100">@lang('Search')</button>
