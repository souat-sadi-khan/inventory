		...
		<div class="col-md-12 text-center mt-3">
			<div class="bg-primary py-2">
			   ...
			   <div class="col-md-12 text-center">
                  <span class="h3 border-one py-1 px-2">@lang('Sale Return Voucher') </span>
              </div>
		</div>
	</div>
	...
	<div class="row mt-5 mx-5">
		<div class="col-md-12">
			<table class="table table-bordered border-0">
				...
				@if ($model->return_parent->discount_amount)
				<tr>
					<td class="border-0"> </td>
					<td class="border-0"></td>
					<td class="py-1"> ডিসকাউন্ট </td>
					<td>{{ $model->return_parent->discount_amount ??  $model->discount_amount }} {{ get_option('currency_symbol') }}</td>
				</tr>
				@endif
				@if ($model->return_parent->tax)
				<tr>
					<td class="border-0"> </td>
					<td class="border-0"></td>
					<td class="py-1"> কর </td>
					<td>{{ $model->return_parent->tax ??  $model->tax }} {{ get_option('currency_symbol') }}</td>
				</tr>
				@endif
