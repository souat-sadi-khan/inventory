@extends('layouts.main', ['title' => ('Sale List'), 'modal' => 'xl',])
                    ...
                    <label for="customer_id">Customer</label>
                        <select name="customer_id" id="customer_id" class="form-control select" >
                         ...
                         @foreach ($customers as $element)
                           <option value="{{ $element->id }}">{{ $element->customer_name }}</option>
                         @endforeach
                    ...
                    <a class="bg-primary">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered content_managment_table" data-url="{{ route('admin.sale_voucher.sale.index') }}">
                                    <thead>
                                        <tr>
                                            <th>@lang('Date')</th>
                                            <th>@lang('Ref')</th>
