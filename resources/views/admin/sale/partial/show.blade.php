...
<div class="row">
	<div class="col-sm-6">
		<b> @lang('Invoice No'):</b> {{ $model->reference_no }}<br>
		<b> @lang('Payment status'):</b> {{ $model->payment_status }}<br>
	</div>
	<div class="col-sm-6">
		<b> @lang('Customer name'):</b>{{ $model->customer?$model->customer->customer_name:''}}<br>
		<b> @lang('Phone') : {{ $model->customer?$model->customer->customer_mobile:'' }}</b><br>
